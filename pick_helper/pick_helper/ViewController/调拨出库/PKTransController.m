...
@interface PKTransController ()<UITextFieldDelegate>{
...
@implementation PKTransController
...
- (void)viewDidLoad {
    ...
    [self pick_setNavWithTitle:@"调拨出库"];
...
-(void)resetQtyLabel:(UILabel *)label{
    ...
    pick_qty.userInteractionEnabled = NO;
...
-(void)checkBeforeTask{
    ...
    NSDictionary * dict = @{@"model":@"internal.trans.mobile",@"method":@"get_pre_line",@"args":@[self.currentDict[@"id"]],@"kwargs":@{}};
...
-(void)checkNextTask{
    ...
    NSDictionary * dict = @{@"model":@"internal.trans.mobile",@"method":@"get_next_line",@"args":@[self.currentDict[@"id"]],@"kwargs":@{}};
    [PickerNetManager pick_requestPickerDataWithURL:PICKER_TASK param:dict callback:^(id responseObject, NSError *error) {
...
-(void)setValueToLabel:(NSDictionary *)dict{
    ...
    pick_des_location.text = dict[@"panwei"];
